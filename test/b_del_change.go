...
func main() {
	...
	bw := []ContainerBW{
		{"10.145.240.113", "1", "100", "1", "all", "", "10", "10", "200", "200", "0"},
		...
		{"10.145.240.113", "1", "100", "1", "10.1.2.5", "delete", "1", "10", "10", "100", "0"},
		{"10.145.240.113", "1", "100", "1", "10.1.2.6", "delete", "2", "10", "20", "100", "5"},
		{"10.145.240.113", "1", "100", "1", "10.1.2.7", "delete", "4", "10", "40", "100", "7"},
		{"10.145.240.131", "2", "102", "2", "10.1.2.8", "delete", "2", "10", "20", "20", "1"},
