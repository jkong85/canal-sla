...
func main() {
	...
	for _, f := range l {
		fmt.Print(f.Index, f.Name)
	}

	bw := []ContainerBW{
		{"192.0.0.1", "1", "100", "1", "all", "add", "100", "100", "100", "100", "0"},
		{"192.0.0.1", "1", "100", "1", "default", "add", "10", "100", "10", "100", "0"},
		{"192.0.0.1", "1", "100", "1", "10.1.2.2", "add", "10", "100", "10", "100", "0"},
		{"192.0.0.1", "1", "100", "1", "10.1.2.3", "add", "10", "100", "10", "100", "5"},
		{"192.0.0.1", "1", "100", "1", "10.1.2.4", "add", "10", "100", "10", "100", "5"},
		{"192.0.0.1", "1", "100", "1", "10.1.2.5", "add", "10", "100", "10", "100", "7"},
	}
