...
func main() {
	...
	bw := []ContainerBW{
		{"10.145.240.113", "1", "100", "1", "all", "add", "100", "100", "100", "100", "0"},
		{"10.145.240.113", "1", "100", "1", "default", "add", "10", "100", "10", "100", "7"},
		...
		{"10.145.240.113", "1", "100", "1", "10.1.2.5", "delete", "10", "100", "10", "100", "0"},
		{"10.145.240.113", "1", "100", "1", "10.1.2.6", "delete", "20", "100", "20", "100", "5"},
		{"10.145.240.113", "1", "100", "1", "10.1.2.7", "delete", "40", "100", "40", "100", "7"},
		{"10.145.240.131", "2", "102", "2", "10.1.2.8", "delete", "20", "100", "20", "20", "1"},
