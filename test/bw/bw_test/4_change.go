...
func main() {
	...
	bw := []ContainerBW{
		...
		{"192.0.0.1", "1", "100", "1", "10.1.2.5", "change", "10", "60", "10", "60", "0"},
		{"192.0.0.1", "1", "100", "1", "10.1.2.6", "change", "10", "60", "10", "60", "5"},
		{"192.0.0.1", "1", "100", "1", "10.1.2.7", "change", "10", "60", "10", "60", "7"},
		{"192.0.0.2", "2", "102", "2", "10.1.2.8", "add", "200", "200", "200", "200", "5"},
		{"192.0.0.2", "2", "102", "2", "10.1.2.9", "add", "200", "200", "200", "200", "7"},
		{"192.0.0.1", "1", "100", "1", "10.1.2.10", "change", "600", "1000", "600", "1000", "0"},
		{"192.0.0.1", "1", "100", "1", "10.1.2.11", "change", "60", "100", "60", "100", "5"},
		{"192.0.0.1", "1", "100", "1", "10.1.2.12", "change", "600", "500", "600", "700", "0"},
		{"192.0.0.2", "2", "102", "2", "10.1.2.13", "change", "600", "200", "600", "200", "5"},
		{"192.0.0.2", "2", "102", "2", "10.1.2.14", "change", "600", "200", "600", "200", "7"},
		{"192.0.0.1", "1", "100", "1", "10.1.2.15", "change", "600", "1000", "600", "1000", "0"},
		{"192.0.0.1", "1", "100", "1", "10.1.2.16", "change", "60", "100", "60", "100", "5"},
		{"192.0.0.1", "1", "100", "1", "10.1.2.17", "change", "600", "500", "600", "700", "0"},
		{"192.0.0.2", "2", "102", "2", "10.1.2.18", "change", "600", "200", "600", "200", "5"},
		{"192.0.0.2", "2", "102", "2", "10.1.2.19", "change", "600", "200", "600", "200", "7"},
		{"192.0.0.1", "1", "100", "1", "10.1.2.20", "change", "600", "1000", "600", "1000", "0"},
		{"192.0.0.1", "1", "100", "1", "10.1.2.21", "change", "60", "100", "60", "100", "5"},
		{"192.0.0.1", "1", "100", "1", "10.1.2.22", "change", "600", "500", "600", "700", "0"},
		{"192.0.0.2", "2", "102", "2", "10.1.2.23", "change", "600", "200", "600", "200", "5"},
