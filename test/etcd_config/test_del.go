...
func main() {
	...
	bw := []ContainerBW{
		{"10.145.240.113", "1", "100", "1", "all", "delete", "100", "100", "100", "100", "0"},
		{"10.145.240.113", "1", "100", "1", "default", "delete", "10", "100", "10", "100", "7"},
		{"10.145.240.113", "1", "100", "1", "10.1.2.52", "delete", "20", "100", "20", "100", "0"},
		{"10.145.240.113", "2", "102", "2", "10.1.2.53", "delete", "20", "100", "20", "100", "5"},
		//{"10.145.240.113", "2", "102", "2", "10.1.2.4", "add", "20", "100", "20", "100", "7"},
	}
