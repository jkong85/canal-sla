...
func main() {
	...
	bw := []ContainerBW{
		...
		{"192.0.0.1", "1", "100", "1", "10.1.2.10", "delete", "600", "1000", "600", "1000", "0"},
		{"192.0.0.1", "1", "100", "1", "10.1.2.11", "delete", "60", "100", "60", "100", "5"},
		{"192.0.0.1", "1", "100", "1", "10.1.2.12", "delete", "600", "500", "600", "700", "0"},
		{"192.0.0.2", "2", "102", "2", "10.1.2.13", "delete", "600", "200", "600", "200", "5"},
		{"192.0.0.2", "2", "102", "2", "10.1.2.14", "delete", "600", "200", "600", "200", "7"},
		{"192.0.0.1", "1", "100", "1", "10.1.2.15", "delete", "600", "1000", "600", "1000", "0"},
		{"192.0.0.1", "1", "100", "1", "10.1.2.16", "delete", "60", "100", "60", "100", "5"},
		{"192.0.0.1", "1", "100", "1", "10.1.2.17", "delete", "600", "500", "600", "700", "0"},
		{"192.0.0.2", "2", "102", "2", "10.1.2.18", "delete", "600", "200", "600", "200", "5"},
		{"192.0.0.2", "2", "102", "2", "10.1.2.19", "delete", "600", "200", "600", "200", "7"},
		{"192.0.0.1", "1", "100", "1", "10.1.2.20", "delete", "600", "1000", "600", "1000", "0"},
		{"192.0.0.1", "1", "100", "1", "10.1.2.21", "delete", "60", "100", "60", "100", "5"},
		{"192.0.0.1", "1", "100", "1", "10.1.2.22", "delete", "600", "500", "600", "700", "0"},
		{"192.0.0.2", "2", "102", "2", "10.1.2.23", "delete", "600", "200", "600", "200", "5"},
