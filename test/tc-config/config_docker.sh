...
NS="sudo "
$NS tc qdisc add dev $1 root handle 1: htb default 20
...
$NS tc class add dev $1 parent 1:1 classid 1:10 htb rate 100bit ceil 100bit burst 1k prio 0
...
tc filter add dev $1 protocol ip parent 1:0 prio 1 u32 match ip dst 0.0.0.0/0 flowid 1:10
