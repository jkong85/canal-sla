...
$NS tc class add dev $1 parent 1:1 classid 1:10 htb rate 1mbit ceil 6mbit burst 15k prio 0
$NS tc class add dev $1 parent 1:1 classid 1:20 htb rate 3mbit ceil 6mbit burst 15k prio 5
$NS tc class add dev $1 parent 1:1 classid 1:30 htb rate 2mbit ceil 6mbit burst 15k prio 7
