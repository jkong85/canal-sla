...
func load_pod_qos_local(data qosInput) map[string]qos_para {
	...
	for i := 0; i < len(data); i++ {
		...
		pod_qos[pod_ip] = qos_para{node_id, pod_id, vlan_id, vxlan_id, pod_ip, action, inbandwidth_min, inbandwidth_max, outbandwidth_min, outbandwidth_max, pod_prio, classid}
	}
