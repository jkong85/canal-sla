...
func main() {
	...
	bw := []ContainerBW{
		{"10.145.240.113", "1", "100", "1", "all", "add", "1000", "1000", "100", "100", "0"},
		{"10.145.240.113", "1", "100", "1", "default", "add", "100", "1000", "10", "100", "5"},
		...
		{"10.145.240.113", "1", "100", "1", "10.1.2.5", "add", "100", "100", "10", "100", "3"},
		{"10.145.240.113", "1", "100", "1", "10.1.2.6", "add", "200", "200", "20", "100", "5"},
		{"10.145.240.113", "1", "100", "1", "10.1.2.7", "add", "400", "400", "40", "100", "7"},
		//{"10.145.240.131", "2", "102", "2", "10.1.2.8", "add", "20", "20", "20", "20", "5"},
